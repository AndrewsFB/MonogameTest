...
{
    internal class SuperJumpState : PlayerState
    {
        private float _jumpForce;
        private float _jumpFrames;
        private float _jumpLimit;

        internal override string Name => "Super Jump";

        internal SuperJumpState(Player player) : base(player)
        {
            _jumpLimit = 15;
            _jumpForce = 30000 / _jumpLimit;
        }
